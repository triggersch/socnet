 ...
 * @ORM\Entity(repositoryClass="OCPlatformBundle\Repository\ApplicationRepository")
...
class Application
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="OCPlatformBundle\Entity\Advert", inversedBy="applications")
